	...
	<div class="main-container">
		<div class="pd-ltr-20">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from users where role = 'admin' ORDER BY users.id desc limit 4") or die(mysqli_error());
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">LATEST APPLY APPLICATIONS</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">STUDENTS NAME</th>
								<th>KEPERLUAN</th>
								<th>APPLIED DATE</th>
								<th>STATUS</th>
