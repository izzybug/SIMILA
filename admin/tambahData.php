...
<?php
    $result = mysqli_query($conn, "SELECT * FROM daftar_istilah_medis");

	if(isset($_POST['proses'])){

		mysqli_query($conn,"insert into daftar_istilah_medis set
		istilah_medis = '$_POST[istilah_medis]',
		pembentukan_istilah_medis = '$_POST[pembentukan_istilah_medis]',
		arti = '$_POST[arti]'") or die(mysqli_error($conn));
